-- we are going to create tools in SNOWFLAKE_INTELLIGENCE.TOOLS schema
    ...
    try:
        ...
        session.sql(f"""
            CALL SYSTEM$SEND_EMAIL(
                'email_integration',-- we are going to create tools in SNOWFLAKE_INTELLIGENCE.TOOLS schema
use role cortex_role;
use snowflake_intelligence.tools;
